...
export class SimulationWasm {
    ...
    static __wrap(ptr) {
        const obj = Object.create(SimulationWasm.prototype);
        obj.ptr = ptr;
    ...
    */
    add_density(x, y, amount) {
        wasm.simulationwasm_add_density(this.ptr, x, y, amount);
    }
    /**
    * @param {number} x
    * @param {number} y
    ...
    * @param {number} dy
    */
    add_velocity(x, y, dx, dy) {
        wasm.simulationwasm_add_velocity(this.ptr, x, y, dx, dy);
    }
    /**
    */
    step() {
        wasm.simulationwasm_step(this.ptr);
    }
    /**
    * @param {number} scale
    */
    draw_density(scale) {
        wasm.simulationwasm_draw_density(this.ptr, scale);
    }
    /**
    */
    draw_velocity() {
        wasm.simulationwasm_draw_velocity(this.ptr);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('fluid_wasm_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
